...
export default function UrlShortener({
    ...
    return (
        <section className="text-center py-12 b order-2 border-gray-100">
            ...
            <form
                className={`${
                    window.innerWidth < 562 && "flex-col items-center"
                } mt-20 flex justify-center gap-4`}
            ...
            >
                <input
                    ...
                    className={`${
                        window.innerWidth < 562 && "w-full"
                    } w-2/3 p-2 rounded-lg text-black bg-[#f9731650] outline-none placeholder:text-gray-700`}
                />
                {!loading ? (
